...
export async function getStaticProps({ params }) {
  ...
  const service =
    blogPosts.map((blog) => blog.link.split('/')[2] === id) || null;
...
export async function getStaticPaths() {
  const paths = blogPosts.map((service) => ({
    params: { id: service.link.split('/')[2] },
  }));
...
export default function BlogSingle() {
  ...
  const filteredData = blogPosts.find((item) => item.link.split('/')[2] === id);
              ...
              <div className="box-pageheader-1 box-pageheader-services text-start pb-30">
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6 mb-30">
                    <div className="d-flex justify-content-start justify-content-lg-end wow animate__animated animate__fadeIn">
                      <span className="font-xs color-grey-700 mr-30">
                        29 May 2022
                      </span>
                      {/* <span className="font-xs color-grey-700 mr-30">
                        125 Views
                      </span>
                      <span className="font-xs color-grey-700 mr-15">
                        Share
                      </span> */}
                      <div className="box-socials wow animate__animated animate__fadeIn">
                    ...
                    <ul className="list-info-footer">
                      ...
                      <li className="wow animate__animated animate__fadeIn">
                        ...
                        <div className="cardInfo">
                          ...
                          <p className="font-sm color-grey-900">info@uma.com</p>
                        </div>
                      </li>
                      <li className="wow animate__animated animate__fadeIn">
                        <div className="cardImage">
